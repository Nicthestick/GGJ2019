	...
	public class SharedCrushersSO : SettingsScriptableObject<SharedCrushersSO>
	{
		...
		public SharedCrusherDefine AddSharedCrusher<T>(SharedCrusherBase<T> instance) where T: Crusher, new()
		{
			...
			if (!exists)
			{
				...
				//Debug.Log("Hashlist add " + instance.hashcode + " " + typeof(T) + " " + hashlist.Contains(instance.hashcode) + " " +
				//	sharedTransformCrusherDef.Count + " " + sharedTransformCrusherHashes.Count + " " +
				//	sharedElementCrusherDef.Count + " " + sharedElementCrusherHashes.Count + " " +
				//	sharedFloatCrusherDef.Count + " " + sharedFloatCrusherHashes.Count
				//);
		...
		{
			Debug.Log("Purging unused SharedCrusherSO entries.");
