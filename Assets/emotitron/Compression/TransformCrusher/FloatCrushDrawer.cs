...
namespace emotitron.Compression
{
	...
	public abstract class CrusherDrawer : PropertyDrawer
	{
		...
		public static GUIStyle miniFadedLabelRight = new GUIStyle((GUIStyle)"MiniLabel") { alignment = TextAnchor.MiddleRight, normal = ((GUIStyle)"PR DisabledLabel").normal };
	...
	public class FloatCrusherDrawer : CrusherDrawer
	{
		...
		private void DrawCodecSettings(SerializedProperty p)
		{
			...
			if (fc.TRSType == TRSType.Euler)
			{
				...
				if (useRange)
					...
					GUI.Label(new Rect(ir.xMin + PADDING + 18, line, 120, LINEHEIGHT), new GUIContent("Limit Ranges"), (GUIStyle)"MiniLabel");
		...
		{
			EditorGUI.LabelField(new Rect(ir.xMin + PADDING, line, labelwidth, LINEHEIGHT), new GUIContent(holdindent < 2 ? "Range:" : "Rng:"), (GUIStyle)"MiniLabel");
			...
			EditorGUI.LabelField(new Rect(label1Left, line, labelW, LINEHEIGHT), new GUIContent("min: "), miniLabelRight);

			float min = EditorGUI.DelayedFloatField(new Rect(input1Left, line - 1, inputW, LINEHEIGHT), GUIContent.none, fc.Min, (GUIStyle)"MiniTextField");
			...
			EditorGUI.LabelField(new Rect(label2Left, line, labelW, LINEHEIGHT), new GUIContent("max: "), miniLabelRight);

			float max = EditorGUI.DelayedFloatField(new Rect(input2Left, line - 1, inputW, LINEHEIGHT), GUIContent.none, fc.Max, (GUIStyle)"MiniTextField");
		...
		private void DrawActualValues()
		{
			...
			EditorGUI.LabelField(new Rect(paddedleft, line, paddedwidth, ACTUAL_HGHT), new GUIContent(holdindent < 2 ? "Actual:" : ""), miniFadedLabel);
